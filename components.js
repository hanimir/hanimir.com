    ...
    if (headerElement) {
        fetch('/header.html')
            ...
            .catch(error => {
                ...
                headerElement.innerHTML = '<div class="site-header-container"><a href="/" class="site-brand">Hani Mir</a></div>';
            });
    }
    ...
    if (footerElement) {
        fetch('/footer.html')
            ...
            .catch(error => {
                ...
                footerElement.innerHTML = '<div class="site-footer-container"><p class="site-footer-text">&copy; 2025 Hani Mir</p></div>';
            });
    }
}
